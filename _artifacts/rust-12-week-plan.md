...
> 为 Marvin 定制 · 节奏:1.5h/天 × 6 天/周 × 12 周 ≈ 108h
> 目标:全面掌握 Rust,含 unsafe / 异步内部 / 宏 / FFI
> 起点:Go/TS/C# 14 年经验,Rust 零基础
...
5. **Onsager 是练兵场**:Week 7 起 Stiglab 的 issue 应该可以独立完成,Week 12 提一个有质量的 PR 作毕业作品。
...
| 33 | 实战:并发 web crawler(借鉴你 Crawlab 的经验,Rust mini 版) | 2h |
| 34 | 复盘 + 写笔记 | 1.5h |
| 35 | 休息 | — |
...
| 41 | 阅读 Stiglab Control Plane 代码,试图看懂 50% | 1.5h |
| 42 | 休息 | — |
...
| 46 | sqlx 加深:`query!` / `query_as!` 宏的编译期检查;你已经用的 `AnyPool` 的工作原理 | 1.5h |
| 47 | 选 Stiglab 一个 small issue 开始实现 | 2h |
| 48 | 继续实现 + 自我 review(用 Claude 或老手帮看) | 2h |
| 49 | 休息 | — |
...
| 日 | 内容 | 时长 |
|---|---|---|
| 50 | Cargo workspace + monorepo(结合 Onsager 实践) | 1.5h |
...
| 82 | 给 Stiglab 提交一个有质量的 PR——毕业作品 | 2h |
| 83 | 写一篇博客:《我是怎么用 12 周从 Go 转到 Rust 的》(中英双发,中文给国内社区) | 2h |
| 84 | 庆祝 🎉 | — |
...
- *Rust for Rustaceans*(Jon Gjengset,中高级话题,**最适合你水平**)
